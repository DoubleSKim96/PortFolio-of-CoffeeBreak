...
<div class="title-wrap-center">
	<h3 class="title-type">커피</h3>
</div>
<div class="menu-list">
	<ul>
		<c:forEach var="c" items="${menu }">
			<c:if test="${c.menuCateCode == 100}">
				<li>
					<div class="product-image">
						<a href="<c:url value='/menu/content?menuCode=${c.menuCode }'/>"> 
							<img class="imageLoad" src="<c:url value='/images/upload/${c.menuImage }'/>">
						</a>
					</div>
